...
public class PokemonStruct {
    ...
    static {
        ...
        pokeDex.put("Pukrin", new EvolvedPokemonStruct(
                ...
                "노래부르기", 0,
                "낙서", 100));
        pokeDex.put("괴력몬", new EvolvedPokemonStruct(
                "괴력몬", 3000,
                "4연속 펀치", 400,
                "8연속 펀치", 800));
    }
    ...
    static {
        pokeEvolveDex.put("Kkobugi", "Unibugi");
...
//    private int skill2Dmg;
    ...
    PokemonStruct(String monsterName, int maxHp, String skill1Name, int skill1Dmg) {
    ...
    PokemonStruct(String monsterName, String nickName, int maxHp, String skill1Name, int skill1Dmg) {
        this.monsterName = monsterName;
    ...
    PokemonStruct(String monsterName, String nickName, int maxHp, String skill1Name, int skill1Dmg, boolean isEvolveByChance) {
        this.monsterName = monsterName;
        this.nickName = nickName;
        this.maxHp = maxHp;
        this.hp = maxHp;
    ...
    public void attack(PokemonStruct targetPokemon) {
        if (targetPokemon.hp > 0) {
            // 피카츄 공격 후 구구 HP 표시
            System.out.println(this.monsterName + "(이)가 " + this.monsterName + "(를)을공격합니다.");
            System.out.println(this.skill1Name + "(를)을 사용합니다.");
            targetPokemon.hp -= this.skill1Dmg;
            System.out.println(targetPokemon.monsterName + "의남은 HP: " + targetPokemon.hp);
            if (targetPokemon.hp <= 0) {
                System.out.println(this.monsterName + " (이)가 항복했습니다.");
            }
        }
        System.out.println("---------------------------------");
    }
    ...
    public void setSkill1Dmg(int skill1Damage) {
        this.skill1Dmg = skill1Damage;
    }
    ...
    public EvolvedPokemonStruct evolve(){
        ...
        return new EvolvedPokemonStruct(newMonsterName, this.nickName,this.maxHp,
    ...
    public PokemonStruct evolveByChance(){
        ...
        int chanceNowDice = round((float) random()*6);
    ...
    public static PokemonStruct[] groupEvolve(ArrayList<PokemonStruct> beforeEvolveArray) {
        ...
        for (PokemonStruct evolvedOrNot : beforeEvolveArray) {
            if(PokemonStruct.pokeEvolveDex.get(evolvedOrNot.getMonsterName()) == null){
                afterEvolvedArray[count] = evolvedOrNot;
            } else {
                afterEvolvedArray[count] = evolvedOrNot.evolve();
            }
