...
public class GenericPokemonTrainer<POKEMON_TYPE extends PokemonStruct> {
    // 제네릭 타입 선언 시, 타입 힌트를 제공해 사용 하능한 타입의 범위를 제한한다.
    private String name;
    ...
    //public void capturedNewPokemonInList(pokemonStruct newPokemon){ //너무 일반적인 타입을 파라미터로 받을 수 없게 됨
    public void capturedNewPokemonInList(POKEMON_TYPE newPokemon){ //너무 일반적인 타입을 파라미터로 받을 수 없게 됨
    ...
    public void setCapturedPokemons(List<POKEMON_TYPE> capturedPokemons) {
